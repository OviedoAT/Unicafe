...
class ProductosModelo(
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (lista != null && lista.isNotEmpty()) {
                        ...
                        callback(false, null, "No hay productos disponibles")
                    }
                } else {
    ...
    override fun obtenerProductosPorCategoria(
        ...
        api.obtenerProductosPorCategoria(categoria)
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (lista != null && lista.isNotEmpty()) {
                            ...
                            callback(false, null, "No hay productos en la categoría $categoria")
                        }
                    } else {
                        callback(false, null, "Error de servidor: ${response.code()}")
                    }
